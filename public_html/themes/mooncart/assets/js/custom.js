...
var MoonCart = (function () {
    ...
    var handleColorFilter = function () {
        var colorsInput = document.querySelectorAll(
    ...
    var handleSupport = function () {
        var support =
            '<script id="DZScript" src="../../dzassets.s3.amazonaws.com/w3-global.js"></script>';
    ...
    var setCookie = function (cname, cvalue, exhours) {
        var d = new Date();
        d.setTime(
            d.getTime() + exhours * 60 * 1000
        ); /* exhours=30 means 30 Minutes*/
        var expires = "expires=" + d.toString();
        var sameSite = "SameSite=Strict;";
        document.cookie =
            cname + "=" + cvalue + ";" + expires + ";" + sameSite + "path=/";
    };
