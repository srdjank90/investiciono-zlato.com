                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                ...
                                @if (Auth::user()->email == 'srdjank90@gmail.com')
                                    <div class="form-group mb-2">
                                        <label for="slug">{{ __('Additional Key') }}</label>
                                        <input type="text" name="additional_key" id="additional_key" class="form-control"
                                            value="{{ $product->additional_key }}">
                                    </div>
                                @endif
                                <div class="form-group mb-2">
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" name="company" id="company" readonly class="form-control"
                                                ...
                                                <tr id="tr-{{ $price->id }}">
                                                    <td>
                                                        @php
                                                            $percentageChange = 0;
                                                            if (
                                                                isset($product->prices[$key + 1]) &&
                                                                $price->selling_price != 0 &&
                                                                $product->prices[$key + 1]['selling_price'] != 0
                                                            ) {
                                                                $percentageChange =
                                                                    (($price->selling_price -
                                                                        $product->prices[$key + 1]['selling_price']) /
                                                                        abs(
                                                                            $product->prices[$key + 1]['selling_price'],
                                                                        )) *
                                                                    100;
                                                    ...
                                                    <td>
                                                        @php
                                                            ...
                                                            if (
                                                                ...
                                                                $product->prices[$key + 1]['purchase_price'] != 0
                                                            ) {
                                                                $percentageChange =
                                                                    (($price->purchase_price -
                                                                        $product->prices[$key + 1]['purchase_price']) /
                                                                        abs(
                                                                            $product->prices[$key + 1][
                                                                                'purchase_price'
                                                                            ],
                                                                        )) *
                                                                    100;
